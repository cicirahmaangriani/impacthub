    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center space-x-2 mb-4">
                    ...
                    <span class="text-2xl font-bold">ImpactHub</span>
                </div>
                <p class="text-gray-400 mb-4 max-w-md">
                    Platform terpercaya untuk menemukan dan mengikuti kegiatan sosial, event, course, dan bootcamp yang mengembangkan potensi Anda.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('events.index') }}" class="text-gray-400 hover:text-white transition">Jelajah Event</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('certificates.verify') }}" class="text-gray-400 hover:text-white transition">Verifikasi Sertifikat</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">
                &copy; {{ date('Y') }} ImpactHub. All rights reserved.
            </p>
            <div class="flex space-x-6 mt-4 md:mt-0">
                <a href="#" class="text-gray-400 hover:text-white text-sm transition">Kebijakan Privasi</a>
                <a href="#" class="text-gray-400 hover:text-white text-sm transition">Syarat Layanan</a>
                <a href="#" class="text-gray-400 hover:text-white text-sm transition">Kebijakan Cookie</a>
            </div>
        </div>
    </div>
</footer>