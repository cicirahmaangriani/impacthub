            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-2">{{ $stats['total_events'] ?? 0 }}</h3>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center space-x-2 mt-2">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                        {{ ($registration->status ?? '') === 'confirmed' ? 'bg-green-100 text-green-800' : ((($registration->status ?? '') === 'pending') ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800') }}">
                                        {{ ucfirst($registration->status ?? 'pending') }}
                                    </span>
                                    <span class="text-xs text-gray-500">
                                        {{ optional($registration->created_at)->diffForHumans() }}
                                    </span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="{{ route('admin.events.create') }}"
                   class="flex flex-col items-center p-6 border-2 border-gray-200 rounded-xl hover:border-indigo-500 hover:shadow-md transition group">
                ...
                <a href="{{ route('admin.manage-users.index') }}"
                   class="flex flex-col items-center p-6 border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:shadow-md transition group">
                ...
                <a href="{{ route('admin.reports.index') }}"
                   class="flex flex-col items-center p-6 border-2 border-gray-200 rounded-xl hover:border-green-500 hover:shadow-md transition group">
                ...
                <a href="{{ route('admin.settings.index') }}"
                   class="flex flex-col items-center p-6 border-2 border-gray-200 rounded-xl hover:border-amber-500 hover:shadow-md transition group">
